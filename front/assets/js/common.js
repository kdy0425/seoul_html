...
$('.active_control button').click(function(){
	$(this).closest('.active_control').find('button').removeClass('active');
	$(this).addClass('active');
});
...
$('#nav > li').hover(function(){
	...
	$('.nav_bg').outerHeight(subHeight).addClass('active');
	$('#nav > li > ul').show();
	$('#nav > li > ul').outerHeight(subHeight);
});
$('#nav > li').mouseleave(function(){
	$('.nav_bg').outerHeight(0).removeClass('active');
	$('#nav > li > ul').hide();
});
...
$('.all_btn').click(function(){
	if(!$(this).hasClass('active')){
		...
		$('.menu_inner,.menu_bg').show();
	    if(devide == 'mobile'){
			$('.hd_links').addClass('active');
	    }
	}else{
		$('.all_btn .txt').text('전체메뉴');
		$('.all_btn').removeClass('active');
		$('.menu_inner,.menu_bg').hide();
		$('.hd_links').removeClass('active');
	}
});
